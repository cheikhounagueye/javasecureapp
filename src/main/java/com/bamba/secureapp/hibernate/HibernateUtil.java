package com.bamba.secureapp.hibernate;
...
import com.bamba.secureapp.config.PropertiesReader;
		...
		if (sessionFactory == null) {
			try {
				...
				settings.put(AvailableSettings.URL,
						"jdbc:mysql://localhost:3306/secureappdatabase?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
